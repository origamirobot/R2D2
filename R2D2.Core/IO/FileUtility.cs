...
namespace R2D2.Core.IO
{
	...
	public class FileUtility : IFileUtility
	{
		...
		/// <param name="destFileName">The name of the destination file. This cannot be a directory</param>
		/// <param name="overwrite">true if the destination file can be overwritten; otherwise, false</param>
		public void Copy(String sourceFileName, String destFileName, Boolean overwrite) => File.Copy(sourceFileName, destFileName, overwrite);
		...
		/// <param name="options">The options.</param>
		/// <returns></returns>
		public FileStream Create(String path, Int32 bufferSize, FileOptions options) => File.Create(path, bufferSize, options);
		...
		/// <param name="bufferSize">Size of the buffer.</param>
		/// <returns></returns>
		public FileStream Create(String path, Int32 bufferSize) => File.Create(path, bufferSize);
		...
		public Boolean Exists(String location) => File.Exists(location);
		...
		/// <param name="path">The path.</param>
		/// <param name="creationTime">The creation time.</param>
		public void SetCreationTimeUtc(String path, DateTime creationTime) => File.SetCreationTimeUtc(path, creationTime);
		...
		/// <param name="path">The path.</param>
		/// <param name="creationTime">The creation time.</param>
		public void SetLastAccessTime(String path, DateTime creationTime) => File.SetLastAccessTime(path, creationTime);
		...
		/// <param name="path">The path.</param>
		/// <param name="creationTime">The creation time.</param>
		public void SetLastAccessTimeUtc(String path, DateTime creationTime) => File.SetLastAccessTimeUtc(path, creationTime);
		...
		/// <param name="path">The path.</param>
		/// <param name="creationTime">The creation time.</param>
		public void SetLastWriteTime(String path, DateTime creationTime) => File.SetLastWriteTime(path, creationTime);
		...
		/// <param name="path">The path.</param>
		/// <param name="creationTime">The creation time.</param>
		public void SetLastWriteTimeUtc(String path, DateTime creationTime) => File.SetLastWriteTime(path, creationTime);
